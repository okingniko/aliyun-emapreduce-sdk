...
object StructuredTableStoreGeoSampleSx extends Logging {
  def main(args: Array[String]): Unit = {
    ...
    //    val geoDistanceQuery = spark.sql("""  SELECT * FROM search_view where  val_geo = '{"centerPoint":"57.188941998439105,35.77072682936891", "distanceInMeter": 10000}'   LIMIT 100   """.stripMargin)
